...
class GithubController extends SocialMediaLoginController {
  ...
  {
    $state = 'stateisok';
    $githubUrl = $this->getBaseAuthorizationUrl();
  ...
  public function callbackGithubAction()
  {
    $code = $_GET['code'];
    ...
    $this->getUsersInfoAction(urldecode($access_token));
  }
